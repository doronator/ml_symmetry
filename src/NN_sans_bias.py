...
constrained to have no bias terms
"""
...
class ConstrainedMLPClassifier(BaseConstrainedMultilayerPerceptron, ClassifierMixin):
...
class ConstrainedMLPRegressor(BaseConstrainedMultilayerPerceptron, RegressorMixin):
