...
rbm = ConstrainedBernoulliRBM(fit_intercepts=False)
...
param_grid = {
    ...
    "logistic__C" : [1, 10, 100, 1000, 6000, 10000],
}

clf = GridSearchCV(model, cv=5, n_jobs=1, param_grid=param_grid)
clf.fit(X_train, y_train)

print("Best parameters set found on development set:")
print()
for key, datum in clf.best_params_.items():
    print(key, datum)
print()
